/* les bons nombres de 'comments' que vous verrez ont été pour des tests */
...
var Snake = (function(){
  ...
  window.onload = setup; /* assure tous les outils sur l'interface necessaire util pour
  le joueur avant qu'il n'interagisse */ 

  var game = {

    /* Cette partie de code définit une fonction appelée "reset" qui réinitialise toutes les variables
    nécessaires pour commencer une nouvelle partie */
    reset: function(){
    ...
    loop: function(){
      ...
      if (player.x == fruit.x && player.y == fruit.y) {
        ...
        reward = 1;
        game.RandomFruit();
        // s'assurer que les nouveaux fruits ne sont pas apparus à la queue de serpent
        while((function () {
